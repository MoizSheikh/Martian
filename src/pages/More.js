  ...
  return (
    <div className="more build">
      ...
      <div className="build-mainDiv more-mainDiv">
        <div className="page-mainHeading">EXPLORE MORE</div>
        <div className="search-field">
          <label className="search-field1" htmlFor="more-search">
            SEARCH
          </label>
          <div>
            <input className="more-search" />
          </div>
        </div>
      </div>
      <img
        class="more-image1 more-img"
      ...
      <img
        class="more-image2 more-img"
        src={process.env.PUBLIC_URL + "/Martian pic5.png"}
        alt="logo"
      />
      <img
        class="more-image3 more-img"
